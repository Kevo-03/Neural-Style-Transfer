        ...
        <nav className="sticky top-0 z-50 w-full border-b border-gray-800 bg-gray-900/80 backdrop-blur-md px-3 sm:px-6 lg:px-8">
            <div className="mx-auto flex h-14 sm:h-16 max-w-7xl items-center justify-between">
                ...
                <div className="flex items-center space-x-3 sm:space-x-6">
                    ...
                    <button
                        onClick={logout}
                        className="rounded-full border border-gray-600 bg-gray-800 px-3 py-1.5 sm:px-5 sm:py-2 text-xs sm:text-sm font-bold text-white hover:bg-gray-700 transition shadow-lg whitespace-nowrap"
                    >
                        Log out
                    </button>
                </div>
