    ...
    <div className="flex flex-col min-h-screen">
      <div className="flex-1 flex flex-col items-center bg-gray-900 px-4 text-center pt-16 sm:pt-32 pb-8">
        <h1 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-white sm:text-6xl">
          <span className="bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent block mb-4 text-5xl sm:text-7xl">
            NeuralArt
          </span>
        ...
        <div className="mt-10 mb-24 flex flex-row flex-wrap justify-center gap-2 sm:gap-4 w-full px-2 sm:px-0">
          <Link
            href="/try"
            className="inline-flex items-center justify-center rounded-full bg-gradient-to-r from-purple-600 to-pink-600 px-4 sm:px-8 py-2 sm:py-3 text-sm sm:text-base font-bold text-white hover:opacity-90 transition md:py-4 md:text-lg"
          >
            Try Out
          </Link>
          <Link
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8">
            ...
            <div className="flex flex-row items-center justify-center gap-2 sm:gap-6 md:gap-8">
              <div className="flex flex-col items-center animate-fade-in [animation-delay:100ms]">
                <div className="h-28 w-28 sm:h-48 sm:w-48 rounded-xl p-[2px] bg-gradient-to-r from-purple-400 to-pink-600 shadow-[0_0_20px_rgba(168,85,247,0.3)]">
                ...
                <span className="mt-4 text-xs sm:text-sm font-bold bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">Content Photo</span>
              </div>

              <div className="text-2xl sm:text-4xl font-light bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">+</div>
              ...
              <div className="flex flex-col items-center animate-fade-in [animation-delay:300ms]">
                ...
                <span className="mt-4 text-xs sm:text-sm font-bold bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent">Style Artwork</span>
              </div>
            </div>

            {/* Mobile Row 2 Arrow / Desktop Equals */}
            <div className="text-3xl sm:text-4xl font-light bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent hidden md:block">=</div>
            <div className="text-3xl font-light bg-gradient-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent md:hidden my-2">↓</div>

            {/* Mobile Row 3 / Desktop Right Column */}
            <div className="flex flex-col items-center animate-fade-in [animation-delay:500ms]">
              <div className="h-40 w-40 sm:h-56 sm:w-56 rounded-xl p-[2px] bg-gradient-to-r from-purple-400 to-pink-600 shadow-[0_0_25px_rgba(236,72,153,0.4)]">
                <div className="relative h-full w-full rounded-[10px] overflow-hidden bg-gray-800">
                  <Image
                    src="/demo-output.jpg"
